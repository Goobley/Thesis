...
lFig = ch2DRT.save_figure('HorizontalResolutionComparison', fig, fext='.pgf', dpi=500)
...
\py[2DRT]|ch2DRT.get_figure('HorizontalResolutionComparison')|
% spell-checker: enable
...
In Fig.~\ref{Fig:HorizontalResolutionComparison} we show the ratio of the outgoing radiation from the 41 point (\SI{50}{\kilo\metre}) and 81 point (\SI{25}{\kilo\metre}) at $t=\SI{10}{\second}$.
...
For this reason the 81 point simulation takes $\sim$3x longer than the 41 point simulation, and we opt to use the 41 point spatial grid in all models presented in this chapter.
...
\TODO{Put the graphs in and discuss this.}
