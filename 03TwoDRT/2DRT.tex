...
\replaced{The \Caii{} K radiation field behaves similarly ot \CaLine{}, but forms slightly higher, with a strong anisotropic component around $z=\SI{1.15}{\mega\metre}$, corresponding roughly with the bottom of the ionisation region depicted in the right-hand panel.
...
\replaced{
It is not easy to disentangle the how the atomic populations in flaring boundary and the slab both contribute to the outgoing radiation.
}{
...
\added{If the thermodynamic properties were allowed to vary through absorption of radiation and cross-field heat conduction (it is difficult to forsee other terms being possible without resorting to 2D RMHD simulation), then the local thermodynamic properties would be more closely linked to the observed radiation and changes in continuum flux would become possible.
