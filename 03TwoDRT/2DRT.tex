...
In reality, the flaring kernels that we are simulating with RHD models are small; on the scale of 10s to 100s of \si{\kilo\metre} \NeedRef{} and represent an estimate of the conditions in the core of a heated flux-tube.
...
It is likely that the plasma neighbouring the flare is substantially cooler, both due to the lack of direct heating, and the low strength of cross-field conduction relative to that along the field, however the radiation is not affected by these limitations.
...
This model can then be used to investigate the outgoing radiation from the slab, as well as the depth of radiation penetration, effects on the atomic populations, and observable signatures.
...
\TODO{Check how we're cutting the top of the sim now, and explain rest of setup.}