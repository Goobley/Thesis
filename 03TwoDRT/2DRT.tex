...
These effects include the possible `core-halo' pattern reported around flare kernels in ground-based line and continuum imaging \citet{Neidig1993,Xu2006}, TRACE white light observations \citep{Hudson2006}, and Hinode/Solar Optical Telescope (SOT) G-band and Fe\,\textsc{i} \SI{630.2}{\nano\m} observations \citep{Isobe2007},
