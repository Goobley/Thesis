...
angularIdx = 1
angularIdxDown = 3
plot_2d_imaging(fig, dataRad, 743, 15, 4, angularIdx, angularIdxDown)
fig.tight_layout()
...
\begin{pycode}[2DRT]
fig = plt.figure(figsize=texfigure.figsize(pytex, scale=1, height_ratio=0.7))
plot_2d_imaging(fig, dataRad, 927, 7, 4, angularIdx, angularIdxDown)
fig.tight_layout()
...
fig = plt.figure(figsize=texfigure.figsize(pytex, scale=1, height_ratio=0.7))
plot_2d_imaging(fig, dataRadF10, 743, 15, 4, angularIdx, angularIdxDown)
fig.tight_layout()
lFig = ch2DRT.save_figure('2DHaF10', fig, fext='.pgf', dpi=500)
lFig.caption = r'\Ha{} for 2D F10 Case.'
\end{pycode}
...
\begin{pycode}[2DRT]
fig = plt.figure(figsize=texfigure.figsize(pytex, scale=1, height_ratio=0.7))
plot_2d_imaging(fig, dataRadF10, 927, 7, 4, angularIdx, angularIdxDown)
fig.tight_layout()
lFig = ch2DRT.save_figure('2DCaF10', fig, fext='.pgf', dpi=500)
lFig.caption = r'\CaLine{} for 2D F10 Case.'
\end{pycode}
...
def plot_ne_radiation_anisotropy_10s(dataPops, ctxBoundary, wlIdxs, lineNames, matchAspectRatios=True):
    ...
    for z in range(atmos.height.shape[0]):
        if abs(atmos.height[z] - atmos.height[zIdxs[-1]]) > 7e4:
            zIdxs.append(z)
