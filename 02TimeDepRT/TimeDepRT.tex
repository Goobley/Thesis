...
\added{
\Lw{} is then responsible for determining the radiation field and atomic level populations throughout the atmosphere using the thermodynamic properties at each timestep loaded from the \Radyn{} output and the populations at the previous timestep.
