...
For \Caii{} H and K, it has been suggested that considering the radiative losses of these lines in CRD approximately accounts for the lack of detailed Mg\,\textsc{ii} h and k treatment if all of these transitions were treated with PRD \citep{Kerr2019a}.
...
These convergence problems are somewhat unexpected due to the reliability of the methods used here when applied here to statistical equilibrium problems \citep[e.g.][]{Uitenbroek2001}.
...
\TODO{tweak paragraph above; too vague}
