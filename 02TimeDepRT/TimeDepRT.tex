...
\end{equation}
Unfortunately, unlike the advection equation, where the stencil has a finite bandwidth, the non-local nature of the RTE means that this process must be undertaken for each depth independently.

In a statistical equilibrium case, the standard statistical equilibrium procedure of formal solution and population update is repeated until convergence is reached.
