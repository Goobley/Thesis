...
for timeToPlot in [11.0, 20.0]:
    fig = plot_cfn(timeToPlot, liData, leData, atmost)
    chRT.save_figure('F9ContFn{:.0f}s'.format(timeToPlot), fig, fext='.pgf', dpi=500)

for timeToPlot in [11.0, 20.0]:
    fig = plot_cfn(timeToPlot, liDataF10, leDataF10, atmostF10)
    chRT.save_figure('F10ContFn{:.0f}s'.format(timeToPlot), fig, fext='.pgf', dpi=500)
\end{pycode}
