...
This H$^-$ ion is formed by the addition of a second electron to a hydrogen atom, it has a low ionisation potential and is a significant component of solar opacity and emissivity across the optical region \citep{Hubeny2014}.
...
The chromosphere is $\sim\SI{2000}{\kilo\m}$ thick, above which the density of the solar plasma drops off rapidly, and in standard reference models the temperature of the plasma starts to rise from approximately 4000--\SI{4500}{\kelvin} \citep{Vernazza1981,Solanki2004}.
...
Despite its much lower temperature than the corona, the chromosphere requires a much larger energy flux to maintain its temperature structure, due to the much higher density of this region \citep{DeMoortel2015}.
The mechanisms proposed for this include acoustic waves propagating from the photosphere for heating the lower chromosphere, and primarily magnetic field effects in the upper chromosphere.
The magnetic field can contribute in a multitude of ways including the dissipation and mode conversion of waves, as well as more direct heating through the release magnetic stresses by reconnection and Joule heating \citep{Carlsson2019}.
...
Determining the energy balance throughout the atmosphere is a very active field of research, necessitating both complex numerical models and detailed observational results \citep{Carlsson2019}.

\section{Solar Flares}

Solar flares are intense flashes of radiation that occur in the solar atmosphere.
They can be observed across the entire electromagnetic spectrum.
