...
\added{The optical depth defines the number of mean free paths for a photon between two points, thus an optical depth of one is often considered to be opaque.}
