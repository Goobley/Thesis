...
\usepackage[small, euler-digits, T1]{eulervm}
...
\usepackage[top=1.8cm, bottom=1.8cm,left=4.0cm,right=1.5cm, includeheadfoot]{geometry}
...
\usepackage[shorthands=off,UKenglish]{babel}
\usepackage{natbib}
...
\bfseries\Large
Solar Chromospheric Response to Impulsive Heating\\
\vspace{2cm}
...
\include{HeatingSignatures}
\include{TimeDepRT}
\include{2DRT}
\include{Radynversion}
