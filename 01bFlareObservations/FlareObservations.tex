...
An in-depth review of different observatories, and the flaring signatures they observe is given in \citet{Fletcher2011}.
...
Flare models with detailed chromospheric treatment are not yet possible in three-dimensions, but with the large gradients in the radiation field that occur in flares it is likely that this requirement will also hold (as supported by the simulations presented in Chap.~\ref{Chap:2DRT}).
